...
<br />
      ...
      <div className=' card  dg-card'>
        ...
        <h5 style={{color:"#650000",fontWeight:"700"}} class="card-title dg-card_title2">GETTING MORE EYES ON YOUR BRAND</h5>

        <div className='d-flex  flex-row justify-content-between'>
            
            <div style={{color:"#995050"}} className='dg-block justify-content-start mt-5 text-start'>
                <p><b>Email Marketing</b></p>
                <p><b>ASO</b></p>
                <p><b>Contact Marketing</b></p>
            </div>
           
            <div style={{color:"#995050"}} className='dg-block justify-content-center mt-5 ml- text-start'>
                <p><b>Branding</b></p>
