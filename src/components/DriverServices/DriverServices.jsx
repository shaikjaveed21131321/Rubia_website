  ...
  return (
   ...
   <main className='w-100 h-auto d-flex flex-column gap-3 align-items-center justify-content-start '>
        ...
        <div style={{color:"#995050"}}>
            <ol>
                ...
                <ul style={{listStyle:"disc"}}>
                    ...
                    <li style={{display:"flex",gap:"10px"}}><a className='btn btn-primary w-auto d-btn-d' href="https://apps.apple.com/in/app/rubia/id6459829353" target='blank'>
                   Download for iOS</a>  
                    <a className='btn btn-primary w-auto d-btn-d' href="https://play.google.com/store/apps/details?id=com.rubia.user&pcampaignid=web_share " target='blank'>
                    Download for Android</a></li>
                </ul>
                <br></br>
    ...
    <section className='w-100 d-flex justify-content-center align-items-center flex-column gap-3'>
        <h2 className='w-100 fw-semibold' style={{fontSize:"14",textAlign:"left",color:"#650000"}}>b&#41;Hire a Permanent /<span style={{color:"#C68643"}}>montly Drivers:</span></h2><br></br>
        
        
        <div style={{background:"#FFF7EF",border:"1px solid #CBCBCB",padding:"10px"}} className='w-100 d-flex flex-row justify-content-start align-item-center  gap-lg-5'>
            <select style={{background:"#FFF7EF",height:"28px",borderRadius:"0px",color:"#650000",padding:"2px 6px 2px",border:"none", borderRight:"1.5px solid #212121"}} className='fw-bold ' >
                <option>Country</option>
            </select>
            <select style={{background:"#FFF7EF",borderRadius:"0px",color:"#650000",padding:"2px 6px 2px",border:"none",borderLeft:"1.5px solid #212121", borderRight:"1.5px solid #212121"}} className='fw-bold ' >
                <option>State</option>
            </select>
            <select style={{background:"#FFF7EF",borderRadius:"0px",color:"#650000",padding:"2px 6px 2px",border:"none",borderLeft:"1.5px solid #212121", borderRight:"1.5px solid #212121"}} className='fw-bold ' >
                <option>City</option>
            </select>
            <select style={{background:"#FFF7EF",borderRadius:"0px",color:"#650000",padding:"2px 6px 2px",border:"none", borderLeft:"1.5px solid #212121"}} className='fw-bold ' >
      ...
      <Swiper
        slidesPerView={(width < 900)? 1 :(width < 1300)?2:(width < 1800)?3:4}
        spaceBetween={5}
        keyboard={{
          enabled: true,
        }}
    ...
    <section style={{ textAlign: "justify",background:"#FFF9F3", }} className='w-100 h-auto d-flex  flex-column p-2 mt-5'>
        ...
        <h1 style={{fontSize: "27px",color:"#650000",textAlign:"left",marginTop:"20px",marginBottom:"25px" }} className='fw-bold'>2.B2B&#x7b;Business to <span style={{color:"#C68643"}}>Business&#x7d;Driver</span></h1>
        <br /><br />
        <p style={{fontSize: "18px", marginRight: "30px",color:"#995050"}} >
        ...
        <div>
            <h5 style={{color:"#650000",marginTop:"10px",marginBottom:"10px"}} className='fw-bold'>Detailed Services Sections:</h5>
            <ul style={{color:"#650000",fontSize:"16px"}}>
                <li style={{marginTop:"10px",marginBottom:"10px"}}><b >For Software Companies:</b> <label style={{fontSize:"16px",color:"#995050"}}>Emphasize driver reliability and scheduling flexibility.</label></li>
                <li style={{marginTop:"10px",marginBottom:"10px"}}><b >For Servicing Centers:</b> <label style={{fontSize:"16px",color:"#995050"}}>Highlight customer satisfaction and prompt services.</label></li>
                <li style={{marginTop:"10px",marginBottom:"10px"}}><b >For Used Vehicle Dealerships:</b> <label style={{fontSize:"16px",color:"#995050"}}>Focus on safe and timely vehicle transportation.</label></li>
            </ul>
        </div>
    ...
    <section style={{ textAlign: "justify",background:"#FFF9F3"}} className='w-100 h-auto d-flex  flex-column p-2 mt-5'><br></br>
        <h1 style={{font: "27",color:"#650000",marginTop:"20px",marginBottom:"10px" }} className='fw-bold'>3. Valet <span style={{color:"#C68643"}}>Parking Drivers</span></h1>
        
        <ul style={{fontSize:"18px",listStyle:"none", color:"#995050",marginTop:"10px",marginBottom:"10px"}}>
            <li style={{marginTop:"10px",marginBottom:"10px", fontWeight:"bold"}}>&#x21db; Pubs</li>
            <li style={{marginTop:"10px",marginBottom:"10px", fontWeight:"bold"}}>&#x21db; Hospitals</li>
            <li style={{marginTop:"10px",marginBottom:"10px", fontWeight:"bold"}}>&#x21db; Restaurant</li>
            <li style={{marginTop:"10px",marginBottom:"10px", fontWeight:"bold"}}>&#x21db; Showrooms</li>
            <li style={{marginTop:"10px",marginBottom:"10px", fontWeight:"bold"}}>&#x21db; Hotels</li>
            <li style={{marginTop:"10px",marginBottom:"10px", fontWeight:"bold"}}>&#x21db; Functions/Party</li>
            <li style={{marginTop:"10px",marginBottom:"10px", fontWeight:"bold"}}>&#x21db; Businesses</li>
        </ul>
    ...
    <section className='w-100 d-flex justify-content-center align-items-center flex-column gap-3 mt-5'>
        <h1 style={{font: "27",color:"#650000",textAlign:"left" }} className='w-100 fw-bold mt-5'>4. Commercial <span style={{color:"#C68643"}}>Vehicle Divers:</span></h1>
        <h2 className='w-100 fw-semibold mt-2 mb-3' style={{fontSize:"25px",textAlign:"left",color:"#650000"}}>a&#41;<u className='fw-bold'>Bus<span style={{color:"#C68643"}}> Drivers:</span></u></h2>
        <div style={{background:"#FFF7EF",border:"1px solid #CBCBCB",padding:"10px"}} className='w-100 d-flex flex-row justify-content-start align-item-center  gap-lg-5'>
            <select style={{background:"#FFF7EF",height:"28px",borderRadius:"0px",color:"#650000",padding:"2px 6px 2px",border:"none", borderRight:"1.5px solid #212121"}} className='fw-bold ' >
                <option>Country</option>
            </select>
    ...
    <section className='w-100 d-flex justify-content-center align-items-center flex-column gap-3 mt-5'>
        <h2 className='w-100 fw-semibold mt-3 mb-3' style={{fontSize:"25px",textAlign:"left",color:"#650000"}}>b&#41; Lorry / Truck <span style={{color:"#C68643"}}>Drivers:</span></h2>
        <div style={{background:"#FFF7EF",border:"1px solid #CBCBCB",padding:"10px"}} className='w-100 d-flex flex-row justify-content-start align-item-center  gap-lg-5'>
            <select style={{background:"#FFF7EF",height:"28px",borderRadius:"0px",color:"#650000",padding:"2px 6px 2px",border:"none", borderRight:"1.5px solid #212121"}} className='fw-bold ' >
                <option>Country</option>
            </select>
    ...
    <section className='w-100 d-flex justify-content-center align-items-center flex-column gap-3 mt-5'>
        <h2 className='w-100 fw-semibold mt-3 mb-3' style={{fontSize:"25px",textAlign:"left",color:"#650000"}}>c&#41; JCB Drivers / <span style={{color:"#C68643"}}>Operators:</span></h2>
        <div style={{background:"#FFF7EF",border:"1px solid #CBCBCB",padding:"10px"}} className='w-100 d-flex flex-row justify-content-start align-item-center  gap-lg-5'>
            <select style={{background:"#FFF7EF",height:"28px",borderRadius:"0px",color:"#650000",padding:"2px 6px 2px",border:"none", borderRight:"1.5px solid #212121"}} className='fw-bold ' >
                <option>Country</option>
            </select>
    ...
    <section className='w-100 d-flex justify-content-center align-items-center flex-column gap-3 mt-5'>
        <h2 className='w-100 fw-semibold' style={{fontSize:"25px",textAlign:"left",color:"#650000"}}>d&#41; Crane Drivers / <span style={{color:"#C68643"}}>Operators:</span></h2>
        <div style={{background:"#FFF7EF",border:"1px solid #CBCBCB",padding:"10px"}} className='w-100 d-flex flex-row justify-content-start align-item-center  gap-lg-5'>
            <select style={{background:"#FFF7EF",height:"28px",borderRadius:"0px",color:"#650000",padding:"2px 6px 2px",border:"none", borderRight:"1.5px solid #212121"}} className='fw-bold ' >
                <option>Country</option>
            </select>
    ...
    <section className='w-100 d-flex justify-content-center align-items-center flex-column gap-3 mt-5'>
        <h2 className='w-100 fw-semibold' style={{fontSize:"25px",textAlign:"left",color:"#650000"}}>e&#41; Tractor <span style={{color:"#C68643"}}>Drivers:</span></h2>
        <div style={{background:"#FFF7EF",border:"1px solid #CBCBCB",padding:"10px"}} className='w-100 d-flex flex-row justify-content-start align-item-center  gap-lg-5'>
            <select style={{background:"#FFF7EF",height:"28px",borderRadius:"0px",color:"#650000",padding:"2px 6px 2px",border:"none", borderRight:"1.5px solid #212121"}} className='fw-bold ' >
                <option>Country</option>
            </select>
    ...
    <section className='w-100 d-flex justify-content-center align-items-center flex-column gap-3 mt-5'>
        <h2 className='w-100 fw-semibold' style={{fontSize:"25px",textAlign:"left",color:"#650000"}}>f&#41; Agriculture / Forming <span style={{color:"#C68643"}}>Machinery Drivers:</span></h2>
        <div style={{background:"#FFF7EF",border:"1px solid #CBCBCB",padding:"10px"}} className='w-100 d-flex flex-row justify-content-start align-item-center  gap-lg-5'>
            <select style={{background:"#FFF7EF",height:"28px",borderRadius:"0px",color:"#650000",padding:"2px 6px 2px",border:"none", borderRight:"1.5px solid #212121"}} className='fw-bold ' >
                <option>Country</option>
            </select>
    ...
    <section className='w-100 d-flex justify-content-center align-items-center flex-column gap-3 mt-5'>
        <h2 className='w-100 fw-semibold' style={{fontSize:"25px",textAlign:"left",color:"#650000"}}>g&#41; Ambulance <span style={{color:"#C68643"}}>Driver:</span></h2>
        <div style={{background:"#FFF7EF",border:"1px solid #CBCBCB",padding:"10px"}} className='w-100 d-flex flex-row justify-content-start align-item-center  gap-lg-5'>
            <select style={{background:"#FFF7EF",height:"28px",borderRadius:"0px",color:"#650000",padding:"2px 6px 2px",border:"none", borderRight:"1.5px solid #212121"}} className='fw-bold ' >
                <option>Country</option>
            </select>
    ...
    <section className='w-100 d-flex justify-content-center align-items-center flex-column gap-3 mt-5 mb-5'>
        <h2 className='w-100 fw-semibold' style={{fontSize:"25px",textAlign:"left",color:"#650000"}}>h&#41; Trailers <span style={{color:"#C68643"}}>Driver:</span></h2>
        <div style={{background:"#FFF7EF",border:"1px solid #CBCBCB",padding:"10px"}} className='w-100 d-flex flex-row justify-content-start align-item-center  gap-lg-5'>
            <select style={{background:"#FFF7EF",height:"28px",borderRadius:"0px",color:"#650000",padding:"2px 6px 2px",border:"none", borderRight:"1.5px solid #212121"}} className='fw-bold ' >
                <option>Country</option>
            </select>
