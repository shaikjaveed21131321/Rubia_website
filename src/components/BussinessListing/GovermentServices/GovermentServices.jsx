   ...
   <br />
    <div className='goverment_services'>
        ...
        <div className='govermentServices_row1'>
            ...
            <div onClick={()=>handleClick(" ")} ><input type="radio" name="lang" id="lang-35" className="radio" /><label htmlFor="lang-35" className='lable label-35' id='g'><img className='services_img' src={Mro} alt="" /><br /> M.R.O <br />Office</label>  </div>
        </div>
        
        <div className={show1} id='govermentServices_row2'>
            
            <div onClick={() => handleClick("Goverment Park")} ><input type="radio" name="lang" id="lang-34" className="radio" /><label htmlFor="lang-34" className='lable label-34' id='g'><img className='services_img' src={ GovermentParks } alt="" />Goverment <br /> Park</label> </div>
            <div onClick={()=>handleClick(" ")} ><input type="radio" name="lang" id="lang-36" className="radio" /><label htmlFor="lang-36" className='lable label-36' id='g'><img className='services_img'  src={Vra} alt="" /><br /> V.R.O <br /> Office</label>  </div>
            <div onClick={()=>handleClick(" ")} ><input type="radio" name="lang" id="lang-37" className="radio" /><label htmlFor="lang-37" className='lable label-37' id='g'><img className='services_img' src={Rto} alt="" /> <br /> R.T.O <br /> Office</label>  </div>
