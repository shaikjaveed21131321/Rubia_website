...
const About = () => {
  ...
  return (
    ...
    <h1  id='header' className='text-start'><u style={{fontWeight:"600",fontSize:"24px"}}>About <span style={{color:"#C68643",fontWeight:"600",fontSize:"24px"}}>us</span></u></h1>
    ...
    <h1 id='header' className='text-start'><u style={{fontWeight:"600",fontSize:"24px"}}>Who <span style={{color:"#C68643",fontWeight:"600",fontSize:"24px"}}>We Are</span> </u></h1>
    ...
    <h1 id='header'  className='text-start'><u style={{fontWeight:"600",fontSize:"24px"}}>Our <span style={{color:"#C68643",fontWeight:"600",fontSize:"24px"}}>Services</span> </u></h1>
    <h5  className='text-start ' ><u style={{fontWeight:"500"}}>We offer a diverse range of services designed to help your business thrive:</u></h5>
    ...
    <h1 id='header' style={{fontWeight:"600",fontSize:"24px"}} className='text-start'>Our <span style={{color:"#C68643",fontWeight:"600",fontSize:"24px"}}>Vision</span></h1>
    ...
    <h1 id='header' style={{fontWeight:"600",fontSize:"24px"}} className=' text-start'>Why <span style={{color:"#C68643",fontWeight:"600",fontSize:"24px"}}>Choose Us?</span> </h1>
    ...
    <div className='d-flex flex-row justify-content-between'>
        <h1 id='header' style={{fontWeight:"600",fontSize:"24px"}}>Our Legal <span style={{color:"#C68643",fontWeight:"600",fontSize:"24px"}}>Documents :</span></h1>
        <div className="" >
