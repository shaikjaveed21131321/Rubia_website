...
const About = () => {
  ...
  return (
    ...
    <h1 className='text-start'>Our <span style={{color:"#C68643",fontWeight:"400"}}>Vision</span></h1>
    ...
    <h1 className=' text-start'>Why <span style={{color:"#C68643",fontWeight:"400"}}>Choose Us?</span> </h1>
    ...
    <div className='d-flex flex-row justify-content-between'>
        <h1>Our Legal <span style={{color:"#C68643",fontWeight:"400"}}>Documents :</span></h1>
        <div className="" >
